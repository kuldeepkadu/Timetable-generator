...
<body>
	...
	<nav>
		...
		<?php
			...
			echo "<table>";
			echo "<tr><th>&nbsp;ID</th><th>YEAR</th><th>SEM</th><th>DEPARTMENT</th><th>Practical-code</th><th>Practical-Name</th><th>Delete</th><th>Update</th></tr>";
			$i=1;
			while($row = mysqli_fetch_array($sqldata,MYSQLI_ASSOC)) {
					...
					echo $row['sub_name'];
					echo "</td><td>";
					echo "<a href='deletePractical.php?id=$row[id]' onclick='return checkDelete()' style='color: red;'>x</a>";
					echo "</td><td>";
					echo "<a href='editPractical.php?id=$row[id]&branch=$row[dept]&year=$row[year]&sem=$row[sem]&subcode=$row[sub_code]&subname=$row[sub_name]'>Edit</a>";
					echo "</td></tr>";
					$i++;
			}
