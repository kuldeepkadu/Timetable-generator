<?php 
	...
	if(isset($_POST['submit']))
	{
		...
		$sub_code = stripcslashes($sub_code);
		$sub_name = stripcslashes($sub_name);
		...
		$sql = "INSERT INTO course (dept,year,sem,sub_code,sub_name,status) VALUES ('$dept','$year','$sem','$sub_code','$sub_name',0)";
				...
				<p class="blink">Fill Course Detail</p>
                   ...
                   <input type="hidden" id="hidden_year" name="hidden_year"  value="<?PHP echo trim($_POST['year']); ?>" />
						...
						<div>
							...
							<input type="subject_code" size="30" maxsize="200px" required oninvalid="setCustomValidity('Invalid Subject Code')" name="subject_code" id="subject_code">
						
							<br>
							<br>
							Subject_Name
							<input type="text" size="49" maxsize="200px" required name="subject_name" id="subject_name">
